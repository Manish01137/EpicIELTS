// (() => {
//   const firstBtn = document.querySelector('.register-btn');
//   const RAZORPAY_KEY_ID = window.RAZORPAY_KEY_ID || firstBtn?.dataset?.key || 'RAZORPAY_KEY_ID_PLACEHOLDER';
...
//     const amountAttr = btn.dataset.amount || btn.getAttribute('data-amount') || '1';
